...
//  para : String = " .";
 ...
 servers : number[] = [1];
  ...
  isCollapsed = true;
  message: String = "Social Medial and Publicity";
  vendor1 : any = "Chamathkara flora";
  vendor2 : any = "NB fashion design";
  vendor3 : any = "Avendra Garden";
  vendor4 : any = "Wills design";
  icon: String;
